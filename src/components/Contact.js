      ...
      <div className="container">
        ...
        <div className="contact-content">
          ...
          <div className="contact-methods">
            <a href="mailto:milind.fnu.791@gmail.com" className="contact-card email-card">
              ...
              <div className="card-content">
                <h4>Email</h4>
                <p>milind.fnu.791@gmail.com</p>
              </div>
            </a>

            <a href="tel:+13128749671" className="contact-card phone-card">
              <div className="card-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          <div className="cta-section">
            <a href="mailto:milind.fnu.791@gmail.com" className="btn btn-primary btn-large">
              Send Me an Email
            </a>
            <p className="response-time">I typically respond within 24-48 hours</p>
          </div>
        </div>
      </div>
    </section>
